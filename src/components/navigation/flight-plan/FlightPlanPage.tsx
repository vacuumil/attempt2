...
export const FlightPlanPage: React.FC = () => {
  ...
  return (
    <Container>
      ...
      {/* Панель учебных маршрутов - теперь только отображает время */}
      <TrainingRoutesPanel 
      ...
      <div style={{ 
        ...
        <ul style={{ margin: '0.5rem 0', paddingLeft: '1.5rem' }}>
          ...
          <li>Установите воздушную скорость V (макс. 900 км/ч) - время в учебных маршрутах пересчитается автоматически</li>
